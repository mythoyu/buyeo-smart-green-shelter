/**
 * 냉난방기 Modbus alarm 값 ↔ 설명
 * packages/frontend/src/meta/coolerAlarmCodes.ts 와 동기 유지
 */
...
export function getCoolerAlarmDescription(alarmValue: number): string {
  return COOLER_ALARM_CODE_MAP[alarmValue] ?? `냉난방기 알 수 없는 오류 (${alarmValue})`;
}
