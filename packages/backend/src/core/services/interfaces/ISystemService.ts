...
export interface ISystemService {
  ...
  setRecoveryPrompt(prompt: PollingRecoveryPrompt): Promise<SystemSettings | null>;
  updateRecoveryPromptStatus(
    promptId: string,
    status: PollingRecoveryPrompt['status'],
  ): Promise<SystemSettings | null>;
  clearRecoveryPrompt(): Promise<SystemSettings | null>;
  ...
  applySnapshotSettings(snapshotData: Record<string, unknown>, appliedBy?: string): Promise<void>;
}
