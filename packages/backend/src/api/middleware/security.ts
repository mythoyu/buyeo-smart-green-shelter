...
// 허용된 포트 목록 (로컬 pnpm dev: 13031/15461, compose·레거시: 3000/5460 등)
const ALLOWED_PORTS = [80, 3000, 4173, 5173, 5460, 8080, 13031, 15461];
...
export const validateCORS = (request: FastifyRequest, _reply: FastifyReply) => {
  ...
  if (!ALLOWED_ORIGINS.includes(origin)) {
    logDebug(`허용되지 않은 Origin: ${origin}`);
    logDebug(`허용된 Origins: ${ALLOWED_ORIGINS.join(', ')}`);
