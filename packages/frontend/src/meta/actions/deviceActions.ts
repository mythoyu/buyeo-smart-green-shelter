...
export const HEATED_BENCH_ACTIONS: { [key: string]: DeviceAction } = {
  ...
  SET_CONT_TEMP: {
    ...
    defaultValue: 25,
    unit: '°C',
    businessLogic: '온열벤치 설정 온도를 -20~80°C 범위로 설정합니다',
  },
  GET_POWER: {
    name: '전원 상태 확인',
    description: '현재 전원 상태 확인',
  ...
  GET_CONT_TEMP: {
    name: '설정 온도 확인',
    description: '현재 설정된 온열벤치 설정 온도 확인',
    unit: '°C',
    businessLogic: '현재 설정된 온열벤치 설정 온도를 읽어옵니다',
  },
  GET_CUR_TEMP: {
    name: '현재 온도 확인',
  ...
  SET_TEMP_OFFSET: {
    ...
    defaultValue: 0,
    unit: '°C',
    businessLogic: '온열벤치 편차값을 0~20°C 범위로 설정합니다',
  },
  GET_TEMP_OFFSET: {
    name: '편차값 확인',
    description: '현재 설정된 온열벤치 편차값 확인',
    unit: '°C',
    businessLogic: '현재 설정된 온열벤치 편차값을 읽어옵니다',
  },
  SET_TEMP_CHECK_INTERVAL: {
    ...
    defaultValue: 30,
    unit: '초',
    businessLogic: '온열벤치 기동 체크시간을 0~600초 범위로 설정합니다',
  },
  GET_TEMP_CHECK_INTERVAL: {
    name: '기동 체크시간 확인',
    description: '현재 설정된 온열벤치 기동 체크시간 확인',
    unit: '초',
    businessLogic: '현재 설정된 온열벤치 기동 체크시간을 읽어옵니다',
  },
};
