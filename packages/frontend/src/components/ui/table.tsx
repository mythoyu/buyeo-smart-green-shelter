...
function TableHeader({ className, ...props }: React.ComponentProps<'thead'>) {
  return (
    <thead
      ...
      className={cn(
        '[&_tr]:border-b [&_tr]:border-border [&_tr]:bg-primary/5 [&_tr]:hover:bg-primary/5',
        className
      )}
      {...props}
    />
...
function TableHead({ className, ...props }: React.ComponentProps<'th'>) {
  return (
    <th
      ...
      className={cn(
        'text-primary h-10 px-3 text-left align-middle text-sm font-semibold whitespace-nowrap [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
        className
      )}
      {...props}
    />
