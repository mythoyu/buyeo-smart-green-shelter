...
#
# fragment 생성 후: ../usb485/03-install-bushub-usb-serial.sh
#
set -euo pipefail
...
echo "   1) PeopleCounter용: bash \"$_SCRIPT_ROOT/../common/02-probe-pc-bushub-usb-serial.sh\" (인덱스별)"
echo "   2) sudo bash \"$_SCRIPT_ROOT/03-install-bushub-usb-serial.sh\""
echo "   (또는 ../00-wizard-bushub-usb-serial.sh)"
